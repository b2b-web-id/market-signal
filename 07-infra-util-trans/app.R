...
# StockIDs
sectoral <- "Infrastrustures etc"
stockIDs <- c('KOPI','LAPD','MPOW','PGAS','POWR','RAJA',
              'TGRA','CMNP','JSMR','META','BTEL','EXCL',
              'FREN','ISAT','TLKM','APOL','ASSA','BBRM',
              'BIRD','BLTA','BULL','CANI','CASS','GIAA',
              'HITS')
